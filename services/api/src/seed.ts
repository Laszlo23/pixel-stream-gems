/** Full competitions payload — mirrors `apps/web/src/data/competitions.ts` for API responses and DB seed. */

export const competitionsPayload = {
  TOP_TIPPING_FANS: [
